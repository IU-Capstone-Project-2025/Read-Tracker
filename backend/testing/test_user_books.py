...
def test_add_user_book():
    ...
    print(add_user_book_response.json())
...
def test_get_user_book():
    ...
    book_id = requests.post(url=get_user_books_url, headers=header, json=get_user_books_data).json()["data"][0]["book_id"]
...
def test_update_user_book():
    ...
    print(updated_book_response.json())
    assert response.status_code == 200
...
def test_delete_user_book():
    ...
    print(deleted_book_response.json())
